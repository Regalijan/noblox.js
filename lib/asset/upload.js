...
exports.optional = ['pollForCompletion', 'jar']
 ...
 * @param {boolean=} pollForCompletion - Whether to wait until the processing operation is done before returning, leave this alone if you do not need the resulting asset id
...
exports.func = async function (args) {
  const { jar, pollForCompletion, uploadOptions } = args
  ...
  if (pollForCompletion && !body.response) {
    return await pollResult({ url: `https://apis.roblox.com/assets/user-auth/v1/${body.path}` })
  }
